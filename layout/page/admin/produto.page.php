<div style="width: 100%; padding: 10px 0px;">
    <div>
        ...
        <?php if (isset($_GET['erro'])): ?>
            <p class="color">Houve um erro: <?php echo $_GET['erro']; ?></p>
        <?php endif; ?>
        <form method="post" enctype="multipart/form-data">
            ...
            <label for="pontos">Pontos do Produto: </label><br />
            <input min="0" type="number" value="<?php echo $prod->getPontos(); ?>" name="pontos" placeholder="Digite a quantidade de pontuação do produto" title="Digite a quantidade de pontos do produto" /><br /><br />
            ...
            <tbody>
                <?php foreach ($produtos as $u): ?>
                    <tr>
                        ...
                        <td><?php echo str_replace('.', ',', $u->getPreco()); ?></td>
