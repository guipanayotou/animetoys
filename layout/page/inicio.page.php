...
<section>
    ...
    <?php if (isset($_GET['pontos'])): ?> 
        <div>
            <h2 style="color: blueviolet"><i class="fa fa-star-o"></i> Você possui <?php echo $_GET['pontos']; ?> pontos.</h2>
        </div>
    <?php endif; ?>
    <?php if (isset($_GET['erro'])): ?>
        <div>
            <h2 class="color"><i class="fa fa-warning"></i> Ops, não foi encontrado ninguém com esse E-Mail...</h2>
        </div>
    <?php endif; ?>
    <br />
